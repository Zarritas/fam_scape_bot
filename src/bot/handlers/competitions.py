...
from src.bot.messages import GENERIC_ERROR, NO_SUBSCRIPTIONS, NO_UPCOMING, UPCOMING_COMPETITIONS
    ...
    try:
        async with session_factory() as session:
            ...
            message = message.replace(
                "🏃 ¡Nuevas competiciones para ti!", "<b>📋 Competiciones para tus pruebas:</b>"
            )
