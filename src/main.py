...
from src.bot.handlers.start import start_command, help_command
...
from src.bot.handlers.competitions import upcoming_command, check_subscriptions_command
...
def create_application() -> Application:
    ...
    application.add_handler(
        CallbackQueryHandler(unsubscribe_callback, pattern=r"^unsub:")
    )
    application.add_handler(
        CallbackQueryHandler(cancel_handler, pattern=r"^cancel$")
    )
    ...
    application.add_handler(
        CallbackQueryHandler(force_scrape_callback, pattern=r"^admin:")
    )
