...
class PDFParser:
    ...
    COMMON_DISCIPLINES = [
        "60", "100", "200", "300", "400", "500", "600", "800", "1.000", "1500", "3000", 
        "60m", "100m", "200m", "300m", "400m", "500m", "600m", "800m", "1000m", "1500m",
        "vallas", "mv", "Altura", "Longitud", "Pértiga", "Triple", "Peso", "Disco", "Jabalina", "Martillo",
        "Marcha", "Cross", "Relevo", "Combinada"
    ]
    ...
    TRACK_KEYWORDS = [
        "carreras", "pruebas de pista", "velocidad", "fondo",
        "vallas", "relevos", "obstáculos",
    ]
    
    FIELD_KEYWORDS = [
        "concursos", "saltos", "lanzamientos", "pruebas de campo",
    ]
    ...
    def parse(
        ...
        try:
            with pdfplumber.open(BytesIO(pdf_content)) as pdf:
                ...
                logger.info(
                    f"Extraídos: fecha={competition_date}, "
                    f"lugar={location}, pruebas={len(events)}"
                )
    ...
    def _extract_name(self, text: str) -> str:
        ...
        keywords = [
            "campeonato", "copa", "trophy", "trofeo", "memorial",
            "meeting", "control", "pruebas", "jornada",
        ]
    ...
    def _parse_events_table(
        ...
        for i, cell in enumerate(header_row):
            ...
            if any(kw in cell_lower for kw in ["prueba", "disciplina", "evento"]):
                ...
                sex_col = i
            elif any(kw in cell_lower for kw in ["hora", "tiempo", "horario", "inicio", "comienzo"]):
                time_col = i
    ...
    def _extract_events_from_text(self, text: str) -> list[Event]:
        ...
        for pattern, event_type in discipline_patterns:
            for match in re.finditer(pattern, text, re.IGNORECASE):
                ...
                if "femen" in context or "mujer" in context:
                    sex = Sex.FEMENINO
                else:
                    sex = Sex.MASCULINO
                ...
                # Evitar duplicados
                existing = any(
                    e.discipline == discipline and e.sex == sex
                    for e in events
                )
                if not existing:
                    events.append(Event(
